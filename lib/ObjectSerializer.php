    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if ($class === '\SplFileObject') {
            ...
            if (array_key_exists('Content-Disposition', $httpHeaders) &&
                ...
                $filename = DevCycleConfiguration::getDefaultConfiguration()->getTempFolderPath() . DIRECTORY_SEPARATOR . self::sanitizeFilename($match[1]);
            } else {
                $filename = tempnam(DevCycleConfiguration::getDefaultConfiguration()->getTempFolderPath(), '');
            }
