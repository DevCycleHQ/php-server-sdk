...
class UserData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @return string[]
     */
    public function getSdkTypeAllowableValues()
    {
        return [
            self::SDK_TYPE_API,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['sdk_version'] =  '1.1.1';
    }
     ...
     * @return object|null
     */
    public function getPrivateCustomData()
    {
     ...
     * @return self
     */
    public function setPrivateCustomData($private_custom_data)
    {
     ...
     * @return self
     */
    public function setLastSeenDate($last_seen_date)
    {
